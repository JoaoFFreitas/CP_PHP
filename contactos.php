...
<body onload="carregarMapa()">
  ...
  <div class="contentWrapper">
    ...
    <form action="dadosContactos.php" class="contactForm" method = "POST">

      Nome<span class="marca">*</span> <input type="text" name="nome" placeholder="O seu nome" required> <br>
      Apelido<span class="marca">*</span> <input type="text" name="apelido" placeholder="O seu apelido" required> <br>
      Telemóvel<span class="marca">*</span> <input type="text" name="numero" placeholder="O seu contacto" required> <br>
      E-mail<span class="marca">*</span> <input type="email" name="mail" id="" placeholder="O seu e-mail" required> <br>
      Data<span class="marca">*</span><input type="date" name="data" id="" required> <br>
      Motivo do Contacto da Reunião<span class="marca">*</span><br>
      <textarea id="" cols="30" rows="3" name="motivo" maxlength="500"  required placeholder="Insira o seu texto aqui..."></textarea> <br>
